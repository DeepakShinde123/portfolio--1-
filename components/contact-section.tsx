      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-8 md:grid-cols-2 mb-12">
          <Link
            ...
            className="flex items-center space-x-4 rounded-lg border-2 bg-background/50 backdrop-blur-sm p-6 shadow-lg hover:bg-background/70 transition-colors"
          >
